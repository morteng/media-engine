    ...
    try:
        async with async_playwright() as p:
            ...
            try:
                ...
                print(f"  ⚠ ffmpeg not available, keeping WebM format")
...
def main():
    parser = argparse.ArgumentParser(
        description="Capture demo videos from ROP demos"
    )
    parser.add_argument('--video', '-v', action='append',
                        help='Specific video(s) to capture')
    parser.add_argument('--lang', action='append',
                        help='Specific language(s) to capture (e.g., en, no)')
